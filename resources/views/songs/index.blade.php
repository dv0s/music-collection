                ...
                <tbody class="text-gray-700">
                    ...
                    <tr>
                        <td colspan="4" class="text-center py-4">
                            Geen resultaten gevonden... <a href="{{ route('song-home') }}" class="text-blue-500 hover:text-blue-600 hover:underline">Terug naar songs home?</a>
                        </td>
                    </tr>
                    @else
