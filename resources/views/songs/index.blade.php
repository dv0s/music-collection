        ...
        <div class="shadow overflow-hidden rounded border-b border-gray-200">
            <table class="w-full bg-white">
                ...
                <tbody class="text-gray-700">
                    ...
                    <tr>
                        <td class="w-1/3 text-left py-3 px-4"><a class="hover:text-blue-500" href="{{ route('song-show', $song->id) }}">{{ $song->title }}</a></td>
                        ...
                        <td class="text-left py-3 px-4"><a class="hover:text-blue-500" href="#">{{ $song->album->artist->name }}</a></td>
                    </tr>                    
                    @endforeach
                </tbody>
            </table>
