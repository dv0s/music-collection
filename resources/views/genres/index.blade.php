                    ...
                    <tr>
                        <td class="text-left py-3 px-4">
                            <div class="flex flex-col flex-wrap">
                                <a class="hover:text-blue-500 text-lg" href="{{ route('song-show', $genre->id) }}">{{ $genre->name }}</a>
                            </div>
                        </td>
                        <td class="text-left py-3 px-4 hidden md:block">
                            <div class="flex flex-row">
                                @if (auth()->user()->can('edit-genre'))    
                                <a href="{{ route('genre-edit', [$genre->id]) }}" class="text-yellow-500 hover:text-yellow-600 hover:underline text-sm uppercase">edit</a>
                                @endif
                            </div>
                        </td>
                    </tr>                    
